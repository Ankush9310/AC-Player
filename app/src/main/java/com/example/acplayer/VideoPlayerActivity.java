...
public class VideoPlayerActivity extends AppCompatActivity {
    ...
    private ImageButton backID, forwardID, playPauseID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playPauseID = findViewById(R.id.idIBPlay);
        forwardID = findViewById(R.id.idIBForward);
        ...
        forwardID.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                videoView.seekTo(videoView.getCurrentPosition() + 10000);
            }
        ...
        playPauseID.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (videoView.isPlaying()) {
                    videoView.pause();
                    playPauseID.setImageDrawable(getResources().getDrawable(R.drawable.ic_play_button));
                } else {
                    videoView.start();
                    playPauseID.setImageDrawable(getResources().getDrawable(R.drawable.ic_pause_button));
                }
            }
        });
